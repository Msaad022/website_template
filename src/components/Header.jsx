                    ...
                    <div className="header-right-content text-center " dir="ltr">
                        <div className="language">
                            <div className="dropdown language-settings">
                                <button className="dropdown-toggle language-btn" type="button" data-bs-toggle="dropdown">
                                    <i className="bx bx-chevron-down"></i>
                                    <span className="bx bx-world"></span>
                                </button>
                                <div className="dropdown-menu">
                                    <a href="#" className="dropdown-item">
                                        <img src="https://fmtest.smappsllc.com/website/assets/images/language/english.png" alt="Flag"/>
                                        <span>English</span>
                                    </a>

                                    <a href="#" className="dropdown-item">
                                        <img src="https://fmtest.smappsllc.com/website/assets/images/language/egypt.svg" alt="Flag"/>
                                        <span>العربية</span>
                                    </a>
            ...
            <div className="container-flud" style={{padding: '0 20px'}}>
                <nav className="navbar navbar-expand-md navbar-light">
                    <a className="navbar-brand" href="#">
                        <img src="https://fmtest.smappsllc.com/website/assets/images/logo.png" alt="logo"/>
                    </a>
                    ...
                    <div className="collapse navbar-collapse mean-menu">
                        <ul className="navbar-nav m-auto">
                            ...
                            <li className="nav-item">
                                <NavLink to='/products/1' className="nav-link">ProductDetails</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink to='/shoppingCart' className="nav-link">ShoppingCart</NavLink>
                            </li>
                            <li className="nav-item">
